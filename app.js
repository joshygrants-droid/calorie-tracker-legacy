...
const DAILY_QUOTE_ROTATION_DAYS = 60;
const DAILY_DISCIPLINE_QUOTES = [
  { text: 'There are things which are within our power, and there are things which are beyond our power.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter I', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Within our power are opinion, aim, desire, aversion, and, in one word, whatever affairs are our own.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter I (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Now the things within our power are by nature free, unrestricted, unhindered; but those beyond our power are weak, dependent, restricted, alien.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter I (passage 4)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Remember, then, that if you attribute freedom to things by nature dependent and take what belongs to others for your own, you will be hindered, you will lament, you will be disturbed, you will find fault both with gods and men.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter I (passage 5)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Aiming, therefore, at such great things, remember that you must not allow yourself any inclination, however slight, toward the attainment of the others; but that you must entirely quit some of them, and for the present postpone the rest.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter I (passage 7)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Seek at once, therefore, to be able to say to every unpleasing semblance, "You are but a semblance and by no means the real thing."', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter I (passage 9)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'And then examine it by those rules which you have; and first and chiefly by this: whether it concerns the things which are within our own power or those which are not; and if it concerns anything beyond our power, be prepared to say that it is nothing to you.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter I (passage 10)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Remember that desire demands the attainment of that of which you are desirous; and aversion demands the avoidance of that to which you are averse; that he who fails of the object of his desires is disappointed; and he who incurs the object of his aversion is wretched.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter II', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'If, then, you shun only those undesirable things which you can control, you will never incur anything which you shun; but if you shun sickness, or death, or poverty, you will run the risk of wretchedness.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter II (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Remove [the habit of] aversion, then, from all things that are not within our power, and apply it to things undesirable which are within our power.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter II (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'But for the present, altogether restrain desire; for if you desire any of the things not within our own power, you must necessarily be disappointed; and you are not yet secure of those which are within our power, and so are legitimate objects of desire.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter II (passage 4)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Where it is practically necessary for you to pursue or avoid anything, do even this with discretion and gentleness and moderation.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter II (passage 5)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'When you set about any action, remind yourself of what nature the action is.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter IV', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'And thus you will more safely go about this action if you say to yourself, "I will now go to bathe and keep my own will in harmony with nature."', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter IV (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'For thus, if any impediment arises in bathing, you will be able to say, "It was not only to bathe that I desired, but to keep my will in harmony with nature; and I shall not keep it thus if I am out of humor at things that happen."', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter IV (passage 5)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Men are disturbed not by things, but by the views which they take of things.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter V', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'When, therefore, we are hindered or disturbed, or grieved, let us never impute it to others, but to ourselves—that is, to our own views.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter V (passage 4)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'It is the action of an uninstructed person to reproach others for his own misfortunes; of one entering upon instruction, to reproach himself; and one perfectly instructed, to reproach neither others nor himself.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter V (passage 5)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Be not elated at any excellence not your own.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter VI', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'So that when you are in harmony with nature in this respect, you will be elated with some reason; for you will be elated at some good of your own.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter VI (passage 6)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'But if you are old, never go far from the ship, lest you should be missing when called for.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter VII (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Demand not that events should happen as you wish; but wish them to happen as they do happen, and you will go on well.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter VIII', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Sickness is an impediment to the body, but not to the will unless itself pleases.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter IX', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Lameness is an impediment to the leg, but not to the will; and say this to yourself with regard to everything that happens.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter IX (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'For you will find it to be an impediment to something else, but not truly to yourself.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter IX (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Upon every accident, remember to turn toward yourself and inquire what faculty you have for its use.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter X', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'If you encounter a handsome person, you will find continence the faculty needed; if pain, then fortitude; if reviling, then patience.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter X (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'And when thus habituated, the phenomena of existence will not overwhelm you.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter X (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Never say of anything, "I have lost it," but, "I have restored it."', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XI', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'While he permits you to possess it, hold it as something not your own, as do travelers at an inn.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XI (passage 10)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'If you would improve, lay aside such reasonings as these: "If I neglect my affairs, I shall not have a maintenance; if I do not punish my servant, he will be good for nothing."', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XII', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'For it were better to die of hunger, exempt from grief and fear, than to live in affluence with perturbation; and it is better that your servant should be bad than you unhappy.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XII (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Say to yourself, "This is the price paid for peace and tranquillity; and nothing is to be had for nothing."', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XII (passage 5)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'But it is not at all desirable for him, and very undesirable for you, that it should be in his power to cause you any disturbance.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XII (passage 7)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'If you would improve, be content to be thought foolish and dull with regard to externals.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XIII', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Do not desire to be thought to know anything; and though you should appear to others to be somebody, distrust yourself.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XIII (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'For be assured, it is not easy at once to keep your will in harmony with nature and to secure externals; but while you are absorbed in the one, you must of necessity neglect the other.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XIII (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'But if you wish not to be disappointed in your desires, that is in your own power.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XIV (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Exercise, therefore, what is in your power.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XIV (passage 4)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Whoever then would be free, let him wish nothing, let him decline nothing, which depends on others; else he must necessarily be a slave.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XIV (passage 6)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Remember that you must behave as at a banquet.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XV', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Put out your hand and take a moderate share.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XV (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Do not yearn in desire toward it, but wait till it reaches you.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XV (passage 7)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'And if you do not so much as take the things which are set before you, but are able even to forego them, then you will not only be worthy to feast with the gods, but to rule with them also.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XV (passage 9)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Take heed, however, not to groan inwardly, too.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XVI (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'If it be his pleasure that you should enact a poor man, or a cripple, or a ruler, or a private citizen, see that you act it well.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XVII (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'For this is your business—to act well the given part, but to choose it belongs to another.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XVII (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'But to me all portents are lucky if I will.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XVIII (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'You can be unconquerable if you enter into no combat in which it is not in your own power to conquer.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XIX', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'But, for your part, do not desire to be a general, or a senator, or a consul, but to be free; and the only way to this is a disregard of things which lie not within our own power.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XIX (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Remember that it is not he who gives abuse or blows, who affronts, but the view we take of these things as insulting.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XX', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'When, therefore, anyone provokes you, be assured that it is your own opinion which provokes you.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XX (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Try, therefore, in the first place, not to be bewildered by appearances.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XX (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'For if you once gain time and respite, you will more easily command yourself.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XX (passage 4)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Let death and exile, and all other things which appear terrible, be daily before your eyes, but death chiefly; and you will never entertain an abject thought, nor too eagerly covet anything.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XXI', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'If you have an earnest desire toward philosophy, prepare yourself from the very first to have the multitude laugh and sneer, and say, "He is returned to us a philosopher all at once"; and, "Whence this supercilious look?"', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XXII', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'Now, for your part, do not have a supercilious look indeed, but keep steadily to those things which appear best to you, as one appointed by God to this particular station.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XXII (passage 2)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'For remember that, if you are persistent, those very persons who at first ridiculed will afterwards admire you.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XXII (passage 3)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'But if you are conquered by them, you will incur a double ridicule.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XXII (passage 4)', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
  { text: 'If you ever happen to turn your attention to externals, for the pleasure of anyone, be assured that you have ruined your scheme of life.', author: 'Epictetus', work: 'The Enchiridion', section: 'Chapter XXIII', sourceUrl: 'https://www.gutenberg.org/ebooks/45109' },
];
